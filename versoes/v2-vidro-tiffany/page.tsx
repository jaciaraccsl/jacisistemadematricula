          ...
          {NAV.map((item) => (
            <button
              ...
              className={`group flex w-full items-center gap-3 rounded-2xl px-4 py-3 text-sm transition-all duration-200 ${
                item.active
                  ? "bg-white/90 text-teal-700 font-semibold shadow-lg"
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="flex items-center gap-4 px-6 py-5">
          ...
          <div className="ml-auto flex items-center gap-3">
            ...
            <span className="grid h-10 w-10 place-items-center rounded-full bg-gradient-to-br from-teal-500 to-blue-900 text-sm font-semibold text-white shadow-lg">
              F
            </span>
          </div>
        </header>
        ...
        <div className="flex-1 space-y-6 px-6 pb-8">
          ...
          <section className="grid grid-cols-2 gap-4 xl:grid-cols-4">
            <KpiCard icon={TrendingUp} label="Total de matrículas" value={kpis.total} from="#0d9488" to="#2dd4bf" />
            <KpiCard icon={Clock} label="Em processo" value={kpis.processo} from="#1e3a8a" to="#3b82f6" />
          ...
          <div className="grid gap-6 xl:grid-cols-3">
            ...
            <section className="glass rounded-3xl p-6">
              ...
              <div className="mt-6 rounded-2xl bg-gradient-to-br from-violet-600 to-purple-500 p-5 text-white shadow-lg">
